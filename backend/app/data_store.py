...
def load_rag_feedback() -> list[dict[str, Any]]:
    return _read_knowledge_json("rag-feedback.json")


def save_rag_feedback(feedback: list[dict[str, Any]]) -> None:
    _write_knowledge_json("rag-feedback.json", feedback)
