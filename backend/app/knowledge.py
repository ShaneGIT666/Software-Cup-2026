...
def ingest_knowledge_document_bytes(
    ...
    document.update({
        ...
        "unverifiedVisualPages": int(visual_result["unverifiedVisualPages"]),
        "ocrTextAvailablePages": int(visual_result["ocrTextAvailablePages"]),
        "ocrEmptyPages": int(visual_result["ocrEmptyPages"]),
